...
11. `references/terraform/generation-guardrails.md`
12. `references/terraform/catalog/terraform-example-catalog.json`
13. `references/terraform/catalog/terraform-reference-catalog.json`
14. `references/command-construction.md`
15. `references/error-playbook.md`
16. `references/output-and-query.md`
17. `references/scripts.md`
18. `references/service-registry.json`
19. `references/service-curation-profiles.json`
20. `scripts/hcloud_catalog_audit.py`
21. `references/playbooks/`
22. `references/source-map.md`
